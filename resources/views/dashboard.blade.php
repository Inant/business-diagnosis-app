...
{{--                                @if($mainSession->nama_bisnis)--}}
{{--                                    <div class="text-center p-4 bg-purple-50 rounded-lg">--}}
{{--                                        <i class="fas fa-store text-purple-500 text-2xl mb-2"></i>--}}
{{--                                        <h4 class="font-semibold text-gray-800 mb-1">Nama Bisnis</h4>--}}
{{--                                        <p class="text-sm text-gray-600">{{ $mainSession->nama_bisnis }}</p>--}}
{{--                                    </div>--}}
{{--                                @endif--}}

{{--                                @if($mainSession->target_audience)--}}
{{--                                    <div class="text-center p-4 bg-blue-50 rounded-lg">--}}
{{--                                        <i class="fas fa-users text-blue-500 text-2xl mb-2"></i>--}}
{{--                                        <h4 class="font-semibold text-gray-800 mb-1">Target Audience</h4>--}}
{{--                                        <p class="text-sm text-gray-600">{{ Str::limit($mainSession->target_audience, 50) }}</p>--}}
{{--                                    </div>--}}
{{--                                @endif--}}

{{--                                @if($mainSession->niche_bisnis)--}}
{{--                                    <div class="text-center p-4 bg-green-50 rounded-lg">--}}
{{--                                        <i class="fas fa-bullseye text-green-500 text-2xl mb-2"></i>--}}
{{--                                        <h4 class="font-semibold text-gray-800 mb-1">Niche Bisnis</h4>--}}
{{--                                        <p class="text-sm text-gray-600">{{ $mainSession->niche_bisnis }}</p>--}}
{{--                                    </div>--}}
{{--                                @endif--}}

{{--                                @if($mainSession->platform_media_sosial)--}}
{{--                                    <div class="text-center p-4 bg-orange-50 rounded-lg">--}}
{{--                                        <i class="fas fa-share-alt text-orange-500 text-2xl mb-2"></i>--}}
{{--                                        <h4 class="font-semibold text-gray-800 mb-1">Platform</h4>--}}
{{--                                        <p class="text-sm text-gray-600">{{ Str::limit($mainSession->platform_media_sosial, 50) }}</p>--}}
{{--                                    </div>--}}
{{--                                @endif--}}
{{--                            </div>--}}
...
{{--                </div>--}}
                    ...
                    <div class="bg-white rounded-xl shadow-lg p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-bold text-blue-600">{{ $contentPlans->count() ?? 0 }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-xl shadow-lg p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-bold text-green-600">{{ $contentPlans->sum('content_count') ?? 0 }}</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-bold text-purple-600">
                                    {{ $contentPlans->where('created_at', '>=', now()->subDays(30))->count() ?? 0 }}
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                @if($contentPlans && $contentPlans->count() > 0)
                    ...
                    <div class="bg-white rounded-xl shadow-lg overflow-hidden mb-8">
                        ...
                        <div class="p-6">
                            <div class="space-y-4">
                                @foreach($contentPlans->take(3) as $index => $contentPlan)
                                    @php
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    <div class="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
                        <div class="text-center">
                            ...
                            <h3 class="text-lg font-semibold text-gray-800 mb-2">Analisa Bisnis</h3>
                            <p class="text-gray-600 text-sm mb-4">Lihat hasil analisa mendalam tentang bisnis Anda</p>
                            <a href="{{ route('front.result', $mainSession->id) }}"
                    ...
                    <div class="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
                        <div class="text-center">
                            ...
                            <h3 class="text-lg font-semibold text-gray-800 mb-2">SWOT Analysis</h3>
                            <p class="text-gray-600 text-sm mb-4">Evaluasi kekuatan dan peluang bisnis Anda</p>
                            <a href="{{ route('front.swot.form', $mainSession->id) }}"
                    ...
                    <div class="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
                        <div class="text-center">
                            ...
                            <h3 class="text-lg font-semibold text-gray-800 mb-2">Generate Konten</h3>
                            <p class="text-gray-600 text-sm mb-4">Buat konten marketing yang menarik dan efektif</p>
                            <a href="{{ route('front.content.create') }}"
                               class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-purple-500 to-pink-600 text-white rounded-lg hover:from-purple-600 hover:to-pink-700 transition-all duration-300">
                                Generate Sekarang
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="mb-8">
                            <div class="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-8">
                                <div class="flex items-center text-sm">
                                    <div class="w-10 h-10 bg-blue-500 text-white rounded-full flex items-center justify-center mr-3 font-bold">1</div>
                                    <span class="font-medium">Analisa Bisnis</span>
                                </div>
                                <div class="hidden sm:block">
                                    <i class="fas fa-arrow-right text-gray-400"></i>
                                </div>
                                <div class="flex items-center text-sm">
                                    <div class="w-10 h-10 bg-green-500 text-white rounded-full flex items-center justify-center mr-3 font-bold">2</div>
                                    <span class="font-medium">SWOT Analysis</span>
                                </div>
                                <div class="hidden sm:block">
                                    <i class="fas fa-arrow-right text-gray-400"></i>
                                </div>
                                <div class="flex items-center text-sm">
                                    <div class="w-10 h-10 bg-purple-500 text-white rounded-full flex items-center justify-center mr-3 font-bold">3</div>
                                    <span class="font-medium">Generate Konten</span>
                                </div>
                            </div>
                        </div>
